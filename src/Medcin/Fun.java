...
public class Fun 
{
	...
	public static DefaultTableModel OrdonanceListToTableModel (Ordonance o )
	{
		DefaultTableModel t = null;
		
		Object data[][] = new String[o.getMedicaments().size()][3] ;
		
		String col[] = new String[3];
		
		for ( int i = 0 ; i < o.getMedicaments().size() ; i ++ )
		{
			data[i][0] =  o.getMedicaments().get(i).getNomMed();
			data[i][1] = ""+o.getMedicaments().get(i).getD().getDose();
			data[i][2] = o.getMedicaments().get(i).getD().getDure();
		}
		col[0] = "Nom";
		col[1] = "Dose";
		col[2] = "Duree";
	...
	public static DefaultTableModel MedicamentListToTableModel (ArrayList<Medicament> m )
	{
		DefaultTableModel t = null;
		
		Object data[][] = new String[m.size()][1] ;
		
		String col[] = new String[1];
		
		for ( int i = 0 ; i < m.size() ; i ++ )
		{
			data[i][0] =  m.get(i).getNomMed();
		}
		col[0] = "Nom";
	...
	public static DefaultTableModel ConsultationStatsListToTableModel (ArrayList<Consultation> c )
	{
		...
		for ( int i = 0 ; i < c.size() ; i ++ )
		{
			Consultation con = new Consultation(c.get(i).getIdConsultation());
			data[i][0] = con.getIdConsultation();
			data[i][1] = con.getPatient().getNom();
			data[i][2] = con.getPatient().getPrenom();
			data[i][3] = ""+con.getPatient().getSexe();
			data[i][4] = ""+con.getPrix();
		}
		col[0] = "Id";
		col[1] = "Nom";
		col[2] = "Prenom";
